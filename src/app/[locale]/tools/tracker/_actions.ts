...
import { defaultLocale, locales, withLocale } from "@/i18n/routing";
import {
  projectCreateSchema,
  projectUpdateSchema,
  taskCreateSchema,
...
const TRACKER_PATH = withLocale(defaultLocale, "/tools/tracker");

function revalidateTracker() {
  for (const locale of locales) {
    revalidatePath(withLocale(locale, "/tools/tracker"));
  }
}
